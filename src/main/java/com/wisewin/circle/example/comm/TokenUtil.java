package com.wisewin.circle.example.comm;
...
public class TokenUtil {
    ...
    private static String CLIENT_ID="YXA676VvsFrDEemZ1zcGL4BPuA";
    private static String CLIENT_SECRET="YXA6pcIsmmZbLJQLYeZbdG2n_q7zQ3c";
