package com.wisewin.circle.util.redisUtils;
...
public class RedissonHandler {
    ...
    private final String ip = "123.56.71.194";//"wisewin-tech.com";

    private final String password = "YJQTD@circle2019";//"sunshibo1!";
